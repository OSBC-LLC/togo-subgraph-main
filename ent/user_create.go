...
func (uc *UserCreate) SetUserImageID(u uuid.UUID) *UserCreate {
	uc.mutation.SetUserImageID(u)
	return uc
}

// SetProfileID sets the "profile_id" field.
func (uc *UserCreate) SetProfileID(u uuid.UUID) *UserCreate {
	uc.mutation.SetProfileID(u)
	return uc
}
...
func (uc *UserCreate) AddDogProfileIDs(ids ...uuid.UUID) *UserCreate {
	uc.mutation.AddDogProfileIDs(ids...)
	return uc
}

// AddDogProfiles adds the "dogProfiles" edges to the DogProfileOwner entity.
func (uc *UserCreate) AddDogProfiles(d ...*DogProfileOwner) *UserCreate {
	ids := make([]uuid.UUID, len(d))
	for i := range d {
		ids[i] = d[i].ID
	}
	return uc.AddDogProfileIDs(ids...)
}
...
func (uc *UserCreate) check() error {
	...
	if _, ok := uc.mutation.UserImageID(); !ok {
		return &ValidationError{Name: "user_image_id", err: errors.New(`ent: missing required field "User.user_image_id"`)}
	}
	if _, ok := uc.mutation.ProfileID(); !ok {
		return &ValidationError{Name: "profile_id", err: errors.New(`ent: missing required field "User.profile_id"`)}
	}
	if _, ok := uc.mutation.UpdatedAt(); !ok {
