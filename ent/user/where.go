...
// UserImageID applies equality check predicate on the "user_image_id" field. It's identical to UserImageIDEQ.
func UserImageID(v uuid.UUID) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldUserImageID), v))
	})
}

// ProfileID applies equality check predicate on the "profile_id" field. It's identical to ProfileIDEQ.
func ProfileID(v uuid.UUID) predicate.User {
	return predicate.User(func(s *sql.Selector) {
...
// UserImageIDEQ applies the EQ predicate on the "user_image_id" field.
func UserImageIDEQ(v uuid.UUID) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldUserImageID), v))
	})
}

// UserImageIDNEQ applies the NEQ predicate on the "user_image_id" field.
func UserImageIDNEQ(v uuid.UUID) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		s.Where(sql.NEQ(s.C(FieldUserImageID), v))
	})
}

// UserImageIDIn applies the In predicate on the "user_image_id" field.
func UserImageIDIn(vs ...uuid.UUID) predicate.User {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
	return predicate.User(func(s *sql.Selector) {
		...
		s.Where(sql.In(s.C(FieldUserImageID), v...))
	})
}

// UserImageIDNotIn applies the NotIn predicate on the "user_image_id" field.
func UserImageIDNotIn(vs ...uuid.UUID) predicate.User {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
	return predicate.User(func(s *sql.Selector) {
		...
		s.Where(sql.NotIn(s.C(FieldUserImageID), v...))
	})
}
...
func ProfileIDNEQ(v uuid.UUID) predicate.User {
	return predicate.User(func(s *sql.Selector) {
...
func ProfileIDIn(vs ...uuid.UUID) predicate.User {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func ProfileIDNotIn(vs ...uuid.UUID) predicate.User {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
